 ...
 * @author Marques
 */
public class FilterValue extends javax.swing.JDialog 
{

    /**
     * Creates new form FilterByName
     */
    public FilterValue(java.awt.Frame parent, boolean modal) 
    {
        super(parent, modal);
        initComponents();
    }
    ...
    {
        double mnemonic = Double.parseDouble( tfValue.getText() );
        this.dispose();
    ...
    private void initComponents() {
        ...
        lbName.setText("Filtrar por Valor Cobrado");

        tfValue.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(tfValue, javax.swing.GroupLayout.PREFERRED_SIZE, 265, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btFilterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btFilterActionPerformed
        generateReport( ApplicationUtilities.REPORT_VALUE_USERS );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FilterValue.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FilterValue dialog = new FilterValue(new javax.swing.JFrame(), true);
